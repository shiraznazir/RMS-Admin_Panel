...
function createData(orderNo, name, phoneNo, status) {
  return {
    orderNo,
    name,
    phoneNo,
  ...
  return (
    <React.Fragment>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
        ...
        <TableCell align="middle">{row.phoneNo}</TableCell>
...
const rows = [
  createData(1121, 'Kallu', 9812345555, 'Pending'),
  createData(1122, 'Mallu', 9812345444, 'Pending'),
];
    ...
    <TableContainer component={Paper}>
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            <TableCell />
            <TableCell align="middle">Order No.</TableCell>
